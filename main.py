...
.up{color:var(--green);}
.down{color:var(--red);}
.st-key-detail_buy_wrap div[data-testid="stButton"] button{background:var(--blue)!important;border-color:var(--blue)!important;color:#fff!important;font-size:1rem!important;padding:14px 0!important;font-weight:700!important;}
.st-key-detail_sell_wrap div[data-testid="stButton"] button{background:var(--red)!important;border-color:var(--red)!important;color:#fff!important;font-size:1rem!important;padding:14px 0!important;font-weight:700!important;}
...
div[class*="st-key-wl_name_"] div[data-testid="stButton"] button{background:transparent!important;border:none!important;padding:0!important;margin:0!important;min-height:0!important;text-align:left!important;font-size:1rem!important;font-weight:700!important;color:var(--text)!important;justify-content:flex-start!important;line-height:1.2!important;}
div[class*="st-key-wl_name_"] div[data-testid="stElementContainer"]{margin-bottom:0!important;}
...
def render_watchlist():
    ...
    for tkr in active_list:
        ...
        with rc1:
            with st.container(key=f"wl_name_{tkr.replace('.', '_')}"):
